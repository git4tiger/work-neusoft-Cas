...
<script type="text/javascript">
	...
	function sendRedirect(){
		window.location.href="<%=request.getParameter("service")%>";
	}
...
<body >
<form id="registeform" name="registeform" action="./user/registeController" method="post">
      ...
      <tr>
        <td height="500" colspan="3" align="center" valign="top"><table width="915" border="0" cellpadding="0" cellspacing="0" bgcolor="#eff2f5">
          <tr>
            ...
            <td align="left" class="dddl_yh_title">用户注册成功</td>
          </tr>
        </table>
          ...
          <table width="715"  border="0" cellspacing="0" cellpadding="0" class="dddl_yh_data">
            ...
            <tr>
              <td colspan="2" align="center"><input class="dddl_yh_btn01" id="submit" type="button" onclick="sendRedirect();" value="返回登录"></td>
              </tr>
          </table></td>
        </tr>
    </table></td>
