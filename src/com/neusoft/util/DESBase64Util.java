...
public class DESBase64Util {
     ...
     * 密码长度必须是8的倍数
     */
    public final static String KEY = "12345985ABCHDNJD";//"RS35836780805258";
    ...
    public static byte[] encrypt(byte[] src, byte[] key) throws Exception {
        ...
        sr.setSeed(securekey.getEncoded()); 
        // Cipher对象实际完成加密操作
    ...
    public static String encodeInfo(String info) {
        ...
        try {
            ...
            System.out.println("加密后："+base64Encode(temp));
            System.out.println("解密后："+decodeInfo(base64Encode(temp)));
    ...
    public static void main(String[] args) {
        ...
        //还原成原文
        String decodeInfo = decodeInfo("1342343");
